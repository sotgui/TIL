...
public class boj17478 {
	...
	static void recursive(int i) {
		...
		if(i == 0) {
			System.out.println(ini + str1);
			System.out.println(ini + answer);
			System.out.println(ini + str5);
		}else {
			System.out.println(ini + str1);
			System.out.println(ini + str2);
			System.out.println(ini + str3);
			System.out.println(ini + str4);
			repeat++;
			recursive(i-1);
			System.out.println(ini + str5);
		}
